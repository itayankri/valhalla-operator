...
func (in *ValhallaSpec) DeepCopyInto(out *ValhallaSpec) {
	*out = *in
	...
	if in.WorkerImage != nil {
		in, out := &in.WorkerImage, &out.WorkerImage
		*out = new(string)
		**out = **in
	}
	if in.MapBuilderImage != nil {
		in, out := &in.MapBuilderImage, &out.MapBuilderImage
		*out = new(string)
		**out = **in
	}
	if in.HistoricalTrafficDataFetcherImage != nil {
		in, out := &in.HistoricalTrafficDataFetcherImage, &out.HistoricalTrafficDataFetcherImage
		*out = new(string)
		**out = **in
	}
